...
$cpanel = new CPANEL();
print $cpanel->header( "Simple Virus Scanner" );
...
<p>This simple file scanner is scanning PHP scripts in all folders for malicious code using several patterns. Each pattern has its 'weight', so the final score is made according to weight and infection probability.</p>
<p>Scanner does not clean files, you have to do it yourself. It only can help you to find the infected code.</p>

        
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <ul class="nav navbar-nav">
<li><a href="https://pcx3.com/wp/how-to-check-if-file-is-infected/" target="_blank" style="">🔴 How to check if a file is actually infected</a></li>     
<li><a href="https://pcx3.com/wp/how-to-clean-up-hacked-wordpress-website-complete-guide/" target="_blank" style="">⚠️ How to clean a hacked WordPress website</a></li>                   
                    </ul>
                </div>
            </nav>
...
class Scanner
{
	...
	function scanFile($id)
	{
		...
		//usage of $USER->Authorize() function with int parameter
 ...
 */
	...
	public function printScanList()
	{
		...
		$this->out("</br> Total scanned files: " . $this->totalFilesScanned);
